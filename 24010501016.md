...
Özellikle yaşlı veya teknolojiyle arası iyi olmayan kullanıcılar ve onların aileleri için tasarlanmış kapsamlı, erişilebilir bir "Çoklu Kullanıcı Destekli (Multi-Tenant) Sağlık Yönetimi" uygulamasıdır. React ve Tailwind CSS ile geliştirilmiştir.
...
└── 24010501016.md              # Proje dokümantasyonu (Bu dosya)
```
